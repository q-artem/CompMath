...
Для решения использовался графический интерфейс (UI).

#figure(
  image("lab4_plot.png", width: 80%),
  caption: [График аппроксимирующих функций в программе],
)

#pagebreak()

= Выводы
В ходе лабораторной работы был реализован метод наименьших квадратов для аппроксимации функций. Были исследованы линейная, полиномиальные (2-й и 3-й степени), экспоненциальная, логарифмическая и степенная модели. Для исходной функции варианта 6 наилучшее приближение показал полином 3-й степени (или 2-й, в зависимости от набора точек), что подтверждается минимальным значением среднеквадратичного отклонения. Разработанный графический интерфейс позволяет наглядно сравнивать модели и анализировать их поведение.
